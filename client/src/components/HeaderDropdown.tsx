...
export default function HeaderDropdown({ user }: HeaderDropdownProps) {
  ...
  return (
    ...
    >
      ...
      <ul
        className={`bg-white flex flex-col justify-around **:flex **:justify-between **:flex-nowrap *:hover:bg-(--petrolBlue)/5 w-[90%] absolute border-b border-l border-r rounded-b top-full right-[5%] transition-all overflow-hidden ${
